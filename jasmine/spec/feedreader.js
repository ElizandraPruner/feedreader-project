...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * page?
         */
        it('allFeeds is defined and is not empty', function() {
    ...
    /* TODO: Write a new test suite named "The menu" */
         ...
         */
         it('When load a page hide menu for default', function(){
          ...
          */
        it ('When the menu icon is clicked, show and hide menu', function(){
